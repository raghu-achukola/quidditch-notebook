...
public class ModifyGameActivity extends ActionBarActivity {
		...
		seasonSpinner.setOnItemSelectedListener(new OnItemSelectedListener(){
			...
			{String[] blankArray = {""};
				if(position!=Spinner.INVALID_POSITION&&position!=0)
				{
					...
					ArrayAdapter<String> adapterTOURN = new ArrayAdapter<String>(ModifyGameActivity.this,android.R.layout.simple_spinner_item,
				...
				{
					tournamentSpinner.setAdapter(new ArrayAdapter<String>(ModifyGameActivity.this, android.R.layout.simple_spinner_item,blankArray));
					isTournament=false;
	...
	regionSpinner1.setOnItemSelectedListener(new OnItemSelectedListener()
	{
		...
		{String[] blankArray = {""};
			...
			{
				int region = position;
				ArrayAdapter<String> adapterT1 = new ArrayAdapter<String>(ModifyGameActivity.this,android.R.layout.simple_spinner_item,
			...
			{
				teamSpinner1.setAdapter(new ArrayAdapter<String>(ModifyGameActivity.this, android.R.layout.simple_spinner_item,blankArray));
				isTeam1=false;
			}
		}
	...
	regionSpinner2.setOnItemSelectedListener(new OnItemSelectedListener()
	{
		...
		{String[] blankArray = {""};
			...
			{
				int region = position;
				ArrayAdapter<String> adapterT2 = new ArrayAdapter<String>(ModifyGameActivity.this,android.R.layout.simple_spinner_item,
						getTeamsArray(teams,region));
			...
			{
				teamSpinner2.setAdapter(new ArrayAdapter<String>(ModifyGameActivity.this, android.R.layout.simple_spinner_item,blankArray));
				isTeam2=false;
			}
		}
	...
	public void next(View v)
	{
		...
		if(!error)
		{Intent i = new Intent(ModifyGameActivity.this,ModifySelectGameActivity.class);
		i.putExtra("game", g);
